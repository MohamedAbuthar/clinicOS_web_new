...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:relative lg:translate-x-0 transition duration-300 ease-in-out z-30 w-70 h-screen bg-white flex flex-col shadow-lg`}>
        {/* Header */}
              ...
              return (
                <li key={item.label}>
                  <button
                    ...
                    className={`w-full flex items-center gap-4 px-5 py-3.5 rounded-2xl transition-all duration-200 ${isActive
